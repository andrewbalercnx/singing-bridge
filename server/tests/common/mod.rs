...
/// deadlock where spawn_app_with's `CREATE DATABASE … TEMPLATE` (which locks the
/// template for new connections during the copy) races with a migration-check connection.
